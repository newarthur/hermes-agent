...
OPTIONAL_ENV_VARS = {
    ...
    "HERMES_GEMINI_CLIENT_ID": {
        "description": "Google Cloud OAuth Client ID for Gemini CLI Code Assist login",
        "prompt": "Gemini CLI OAuth Client ID (leave empty for default)",
        "url": None,
        "password": False,
        "category": "provider",
        "advanced": True,
    ...
    "HERMES_GEMINI_CLIENT_SECRET": {
        "description": "Google Cloud OAuth Client Secret for Gemini CLI Code Assist login",
        "prompt": "Gemini CLI OAuth Client Secret (leave empty for default)",
        "url": None,
        "password": True,
        "category": "provider",
        "advanced": True,
    ...
    "HERMES_GEMINI_PROJECT_ID": {
        "description": "Google Cloud Project ID for Gemini CLI Code Assist",
        "prompt": "Gemini CLI Google Cloud Project ID (leave empty for default)",
        "url": None,
        "password": False,
        "category": "provider",
        "advanced": True,
